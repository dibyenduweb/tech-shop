...
const Home = () => {
    ...
    return (
        ...
        <Container>
        <Header/>
        <div className="lg:h-[500px] relative text-white lg:bg-cover text-center py-44 mt-16" style={{backgroundImage: 'url(https://i.ibb.co/yYbhvRL/Blue-Teal-Geometric-Technology-Linkdln-Banner.png)'}}>
